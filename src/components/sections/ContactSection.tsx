...
function WhatsAppIcon({ isScrolled = false }: WhatsAppIconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={`transition-all duration-300 ${isScrolled ? 'w-4 h-4' : 'w-5 h-5'}`}>
      ...
      >
        <div className="flex gap-2 max-w-sm mx-auto">
          ...
          <button
            ...
            className={`flex-1 relative overflow-hidden flex flex-col items-center justify-center gap-0.5 bg-gradient-to-b from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-lg font-bold text-xs active:scale-95 transition-all shadow-lg shadow-orange-300/40 ${
              isScrolled ? 'py-1' : 'py-1.5'
            }`}
            style={{
              transform: isScrolled ? 'scale(0.93)' : 'scale(1)',
          ...
          >
            ...
            <span className={`overflow-hidden transition-all duration-300 ${isScrolled ? 'h-0 text-[0px]' : 'h-auto text-xs'}`}>Llamar</span>
          </button>
          ...
          <button
            ...
            className={`flex-1 relative overflow-hidden flex flex-col items-center justify-center gap-0.5 bg-gradient-to-b from-[#25D366] to-[#20ba58] hover:from-[#20ba58] hover:to-[#1aad50] text-white rounded-lg font-bold text-xs active:scale-95 transition-all shadow-lg shadow-green-300/40 ${
              isScrolled ? 'py-1' : 'py-1.5'
            }`}
            style={{
              transform: isScrolled ? 'scale(0.93)' : 'scale(1)',
          ...
          >
            <WhatsAppIcon isScrolled={isScrolled} />
            <span className={`overflow-hidden transition-all duration-300 ${isScrolled ? 'h-0 text-[0px]' : 'h-auto text-xs'}`}>WhatsApp</span>
          </button>
          ...
          <button
            ...
            className={`flex-1 relative overflow-hidden flex flex-col items-center justify-center gap-0.5 text-amber-800 border border-amber-200/40 bg-white/30 hover:bg-white/40 rounded-lg font-bold text-xs active:scale-95 transition-all shadow-lg shadow-amber-200/10 backdrop-blur-md ${
              isScrolled ? 'py-1' : 'py-1.5'
            }`}
            style={{
              transform: isScrolled ? 'scale(0.93)' : 'scale(1)',
          ...
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} className={`transition-all duration-300 ${isScrolled ? 'w-4 h-4' : 'w-5 h-5'}`}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
            </svg>
            <span className={`overflow-hidden transition-all duration-300 ${isScrolled ? 'h-0 text-[0px]' : 'h-auto text-xs'}`}>Email</span>
          </button>
        </div>
      </div>
    </>
