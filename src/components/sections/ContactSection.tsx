...
export default function ContactSection({ pet }: ContactSectionProps) {
  ...
  return (
    <>
      ...
      <div
        ref={stickyBarRef}
        className={`bg-white/20 backdrop-blur-3xl fixed bottom-0 left-0 right-0 z-50 md:hidden transition-all duration-300 ease-out ${
      ...
      >
        <div className="flex gap-2 max-w-sm mx-auto">
          ...
          >
            ...
            <span
              className={`overflow-hidden transition-all duration-300 ${isScrolled ? "h-0 text-[0px]" : "h-auto text-xs"}`}
            >
              Llamar
            </span>
          </button>
